<?php /* Smarty version Smarty-3.1.18, created on 2016-11-21 16:14:46
         compiled from "application\views\sys_cms_content_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:131055832acf6e1f147-85868876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3927ec747eabd806cea7bf5611d201c9b334b36c' => 
    array (
      0 => 'application\\views\\sys_cms_content_edit.html',
      1 => 1458201760,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '131055832acf6e1f147-85868876',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5832acf8184c78_62085210',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5832acf8184c78_62085210')) {function content_5832acf8184c78_62085210($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'D:\\phpStudy\\WWW\\sunnycms\\application\\libraries\\Smarty\\plugins\\function.html_options.php';
...
<script type="text/javascript" charset="utf-8" src="<?php echo dirname('__FILE__');?>
/resources/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo dirname('__FILE__');?>
/resources/ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript" charset="utf-8" src="<?php echo dirname('__FILE__');?>
/resources/ueditor/lang/zh-cn/zh-cn.js"></script>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("inc_form_result.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '131055832acf6e1f147-85868876');
content_5832acf782bc72_88855926($_smarty_tpl);
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input type="text" name="headimage" id="headimage" class="col-xs-12 col-sm-6"
                        value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['entity']->value['headimage'])===null||$tmp==='' ? '' : $tmp);?>
" />
            </div><img src="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['entity']->value['headimage'])===null||$tmp==='' ? '' : $tmp);?>
">
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <select name="cid" id="cid" class="col-xs-12 col-sm-6" onchange="setCatname(this);">
                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['group_list']->value,'selected'=>$_smarty_tpl->tpl_vars['entity']->value['cid']),$_smarty_tpl);?>

                </select>
                <input type="hidden" id="catname" name="catname" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['entity']->value['catname'])===null||$tmp==='' ? '' : $tmp);?>
">
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input type="text" id="newsdate" name="newsdate" class="col-xs-12 col-sm-6"
                       value="<?php echo (($tmp = @date('Y-m-d',$_smarty_tpl->tpl_vars['entity']->value['newsdate']))===null||$tmp==='' ? '' : $tmp);?>
" />
            </div>
        </div>
    </div>
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.18, created on 2016-11-21 16:14:47
         compiled from "application\views\inc_form_result.html" */ ?>
<?php if ($_valid && !is_callable('content_5832acf782bc72_88855926')) {function content_5832acf782bc72_88855926($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['error']->value)) {?>
